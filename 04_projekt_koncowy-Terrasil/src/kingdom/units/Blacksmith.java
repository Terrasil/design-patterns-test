...
public class Blacksmith extends Human implements Unit {
    private String name = "Kowal";
    private UnitType unitType = UnitType.BLACKSMITH;
    private Blacksmith(Builder builder) {
